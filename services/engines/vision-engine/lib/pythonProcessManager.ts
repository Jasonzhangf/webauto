...
export class PythonProcessManager {
  constructor({ host = '127.0.0.1', port = 8899, pythonBin = process.env.PYTHON_BIN || 'python3', entry = process.env.PY_SERVICE_ENTRY || 'libs/ui-recognition/python-service/ui_ins_server.py' } = {}) {
    this.host = host;
    this.port = port;
