 ...
 */
import { WorkflowState, WorkflowEventType } from './types/WorkflowTypes';
import { OperatorState } from '../core/types/OperatorTypes';
...
export class SimpleWorkflowEngine extends EventEmitter {
    ...
    getNextStepId(workflow, currentStep, success) {
    ...
    createWorkflowContext(workflow, sessionId, initialData) {
        const context = {
            workflowId: workflow.id,
            sessionId,
    ...
    extractSharedData(params, sharedData) {
        const extracted = {};
    ...
    updateSharedData(stepId, data, sharedData) {
    ...
    emitWorkflowEvent(type, workflowId, sessionId, data) {
        const eventData = {
            type,
            timestamp: Date.now(),
            workflowId,
    ...
    updateStats(result) {
        ...
        this._stats.averageExecutionTime = ((this._stats.averageExecutionTime * (this._stats.totalWorkflows - 1) + result.executionTime) /
            this._stats.totalWorkflows);
...
//# sourceMappingURL=SimpleWorkflowEngine.js.map