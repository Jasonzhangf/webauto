...
export class WorkflowExecutor {
     ...
     */
    async executeFromFile(workflowPath, inputVariables, options) {
        try {
     ...
     */
    async execute(workflow, inputVariables, options = {}) {
     ...
     */
    async executeMultiple(workflows, inputVariables, options) {
        const results = [];
...
export async function executeWorkflow(workflow, variables, options) {
    return await workflowExecutor.execute(workflow, variables, options);
}
export async function executeWorkflowFromFile(path, variables, options) {
