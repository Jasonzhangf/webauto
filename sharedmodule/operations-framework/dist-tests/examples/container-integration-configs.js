 ...
 */
// ==================== 微博主页链接获取配置 ====================
export const homepageLinkCaptureConfig = {
...
// ==================== 微博搜索页面链接获取配置 ====================
export const searchPageLinkCaptureConfig = {
...
// ==================== 微博用户主页链接获取配置 ====================
export const userProfileLinkCaptureConfig = {
...
// ==================== 高级混合模式配置 ====================
export const advancedHybridCaptureConfig = {
...
export class ContainerConfigManager {
    ...
    createCustomConfig(baseKey, overrides) {
...
//# sourceMappingURL=container-integration-configs.js.map