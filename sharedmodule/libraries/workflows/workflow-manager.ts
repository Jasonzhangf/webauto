...
class WorkflowManager {
  private workflows: {
    homepage: WeiboHomepageWorkflow;
    search: WeiboSearchWorkflow;
    profile: WeiboProfileWorkflow;
  };
  ...
  async executeWorkflow(type: string, params: ExecuteParams = {}): Promise<any> {
