...
exports.PageOperationCenter = void 0;
/**
 * 页面操作中心
 * 提供统一的页面交互接口
 */
class PageOperationCenter {
    /**
     * 点击元素
     */
    ...
    async extractContent(page, options = {}) {
        try {
            const { includeLinks = true, includeImages = true, includeText = true, maxDepth = 3 } = options;
            const result = {
                text: '',
                links: [],
                images: [],
     ...
     * 等待元素
     */
    async waitFor(page, selector, options = {}) {
        try {
...
exports.PageOperationCenter = PageOperationCenter;
//# sourceMappingURL=SimplePageOperationCenter.js.map