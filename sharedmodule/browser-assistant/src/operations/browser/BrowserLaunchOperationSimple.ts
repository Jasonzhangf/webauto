import { BaseOperation, OperationContext, OperationResult, OperationConfig } from '../core/BaseOperationSimple';
...
export class BrowserLaunchOperation extends BaseOperation {
  name = 'browser-launch';
  ...
  async execute(context: BrowserOperationContext, params?: BrowserLaunchParams): Promise<OperationResult> {
    try {
      const config = params || {};
