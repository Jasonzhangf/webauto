...
exports.BrowserWorkflowEngine = void 0;
class BrowserWorkflowEngine {
    operationRegistry;
    contextManager;
    constructor(operationRegistry, contextManager) {
        ...
        try {
            for (let i = 0; i < workflow.steps.length; i++) {
                ...
                try {
                    ...
                    const result = await this.executeWithTimeout(operation.execute(context, step.parameters), timeout);
                    results.push(result);
    ...
    static createBasicNavigationWorkflow(url) {
        return {
    ...
    static createWeiboLoginWorkflow(username, password) {
        return {
            name: 'weibo-login',
...
exports.BrowserWorkflowEngine = BrowserWorkflowEngine;
//# sourceMappingURL=BrowserWorkflowEngine.js.map