...
export function resolveXhsUnifiedOptions(rawOptions = {}) {
  ...
  const openDetailPostOpenMinMs = toPositiveInt(rawOptions.openDetailPostOpenMinMs, 400, 0);
  const openDetailPostOpenMaxMs = toPositiveInt(rawOptions.openDetailPostOpenMaxMs, 1800, openDetailPostOpenMinMs);
