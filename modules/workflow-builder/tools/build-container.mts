...
import { InteractiveDOMBuilder } from '../src/dom-analyzer/InteractiveDOMBuilder.js';
...
使用方法:
  node tools/build-container.mts [profile] [url]

示例:
  node tools/build-container.mts weibo_fresh https://weibo.com
