...
// Usage:
//   node runtime/infra/utils/scripts/local-dev/inject-sid-panel.mjs --sid <SESSION_ID> [--host http://127.0.0.1:7701]
...
if (!SID) {
  console.error('Usage: node runtime/infra/utils/scripts/local-dev/inject-sid-panel.mjs --sid <SESSION_ID> [--host http://127.0.0.1:7701]');
  process.exit(1);
}
