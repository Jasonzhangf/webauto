...
// Usage:
//   node runtime/infra/utils/scripts/local-dev/highlight-captcha.mjs --sid <SESSION_ID> [--host http://127.0.0.1:7701] [--frame nocaptcha]
...
if (!SID) {
  console.error('Usage: node runtime/infra/utils/scripts/local-dev/highlight-captcha.mjs --sid <SESSION_ID> [--host http://127.0.0.1:7701] [--frame nocaptcha]');
  process.exit(1);
}
