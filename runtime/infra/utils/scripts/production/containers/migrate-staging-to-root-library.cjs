 ...
 *
 * 用法示例：
 *   node runtime/infra/utils/scripts/production/containers/migrate-staging-to-root-library.cjs
 *   node runtime/infra/utils/scripts/production/containers/migrate-staging-to-root-library.cjs --site-folder 1688.com
 */
