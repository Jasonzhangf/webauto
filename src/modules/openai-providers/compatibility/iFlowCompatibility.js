...
class iFlowCompatibility extends GenericCompatibility {
      ...
      'choices': (choices) => {
        ...
        return choices.map(choice => {
          ...
          if (choice.message && choice.message.reasoning_content) {
            ...
            transformedChoice.message.reasoning_content = choice.message.reasoning_content;
          }
  ...
  mapResponse(providerResponse) {
    ...
    // 应用iFlow特定的转换
    for (const [field, transform] of Object.entries(this.specialResponseTransforms)) {
