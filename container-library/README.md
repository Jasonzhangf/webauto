...
1. **根容器（page）**：与某个 URL 模式对应，包含 `page_patterns`、`selectors`、`children`。示例：`container-library/xiaohongshu/detail/container.json`。
...
- `container-library/weibo`（已有成熟示例）

Workflow/Agent 调试规范见 `docs/arch/AGENTS.md`。
